...
refMarker = DistanceFinder.find_square_marker(refImage)
...
for imagePath in paths.list_images(args["images"]):
    ...
    marker = DistanceFinder.find_square_marker(image)
...
# python distance_to_object.py --reference ref_24in.jpg --ref-width-inches 4.0 --ref-distance-inches 24.0 --images images