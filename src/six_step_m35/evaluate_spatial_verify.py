...
from src.six_step_m35.ir.bovw import BagOfVisualWords
from src.six_step_m35.ir.spatialverifier import SpatialVerifier
from src.six_step_m35.ir.searcher import Searcher
...
for (i, queryID) in list(enumerate(sorted(queryIDs))):
	print(i, queryID)
	...
	pbar.update(i)  # release any pointers allocated by the searcher
searcher.finish()
pbar.finish()
