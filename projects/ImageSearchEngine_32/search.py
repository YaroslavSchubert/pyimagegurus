...
from cbir.resultsmontage import ResultsMontage
...
montage = ResultsMontage((240, 320), 5, numResults=num_results)
...
results = searcher.search(features, numResults=num_results)
